...
varsDf <- data.frame(row.names = c(variables, "Tmin"),
                     ...
                     "ERA5" = c(4, 3, 6, 7, 1, 8, NA, NA, NA, 9),
                     "GLDAS" = c("AvgSurfT_inst", "Tair_f_inst", "SoilTMP40_100cm_inst", "Lwnet_tavg", "Wind_f_inst", "Rainf_f_tavg", "Qair_f_inst", "SoilMoi40_100cm_inst", NA, "Tmin"),
...
nameDf <- data.frame(row.names = variables, 
                     ...
                     "ERA5" = c("Hourly skin temperature", "Hourly air temperature 2 m above ground", "Hourly soil temperature 28-100 cm below ground", "Hourly surface net solar radiation", "Hourly wind speed 10 m above ground", "Total precipitation", NA, NA, NA),
                     "GLDAS" = c("3-hourly average surface skin temperature", "3-hourly average air temperature", "3-hourly average soil temperature 40-100 cm below ground", "3-hourly net longwave radiation flux", "3-hourly average wind speed", "Total precipitation", NA, "3-hourly average soil moisture 40-100 cm below ground", NA),
